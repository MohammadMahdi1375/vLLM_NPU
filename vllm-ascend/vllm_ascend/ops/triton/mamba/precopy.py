...
def precopy_mamba_align_fused_kernel(
    ...
    # Ascend currently performs the full state copy in one CTA.
    # Upstream launches a 3-D grid with TEMPORAL_TILES, so only
    # tile 0 should execute the original copy.
    if tile_idx > 0:
        return
